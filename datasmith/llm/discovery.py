...
_SYSTEM_PROMPT = (
    ...
    "  Choose carefully: counts/quantities/ages/years → integer, "
    "prices/percentages/measurements → numeric, names/categories → text.\n"
    "- For numeric/integer columns: provide min, max, and mean. "
